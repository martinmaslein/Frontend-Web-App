...
function DrumAccesories() {
	...
	const filteredProducts = products.filter((product) => product.subcategory_id === 12);
	...
	return (
		<CenterContent>
			{loading ? (
				...
				<>
					<h2 className="text-2xl font-bold mb-4"><Subcategory subcategoryId={12} /></h2>
