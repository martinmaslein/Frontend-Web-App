...
function ElectronicDrums() {
	...
	const filteredProducts = products.filter((product) => product.subcategory_id === 11);

	return (
		<CenterContent>
				<h2 className="text-2xl font-bold mb-4"><Subcategory subcategoryId={11} /></h2>
