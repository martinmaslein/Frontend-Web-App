  ...
  return (
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={guitarDetails.image_link} />
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>
          <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{guitarDetails.name}</h1>
          <div class="flex mb-4">
            <span class="flex items-center">
              ...
              <span class="text-gray-600 ml-3">53 Reviews</span>
            </span>
          ...
          <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
            ...
            <div class="flex flex-col ml-2">
              ...
              <span class="text-green-500"><b>In-Stock</b></span>
            </div>
          </div>

          <div class="flex">
            <span class="title-font font-medium text-2xl text-gray-900">${guitarDetails.price}</span>
            ...
            <button id='addToCartButton'class="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
