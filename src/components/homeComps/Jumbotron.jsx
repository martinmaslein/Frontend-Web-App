    ...
    return (
        ...
        <section className="bg-center bg-no-repeat bg-[url('https://media.timeout.com/images/102747673/image.jpg')] rounded-lg shadow-md p-8 bg-gray-700 bg-blend-multiply">
            <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                ...
                <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">En Melody Marketplace nos enfocamos siempre en la satisfacción del cliente, brindando los últimos y mejores productos de calidad</p>
