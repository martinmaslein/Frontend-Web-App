...
function AcousticBasses() {
	...
	const filteredProducts = products.filter((product) => product.subcategory_id === 5);
	...
	return (
		<CenterContent>
			{loading ? (
				...
				<>
					<h2 className="text-2xl font-bold mb-4"><Subcategory subcategoryId={5} /></h2>
