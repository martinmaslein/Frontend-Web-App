...
function AudioInterfaces() {
	...
	const filteredProducts = products.filter((product) => product.subcategory_id === 17);
	...
	return (
		<CenterContent>
			{loading ? (
				...
				<>
					<h2 className="text-2xl font-bold mb-4"><Subcategory subcategoryId={17} /></h2>
...
export default AudioInterfaces;